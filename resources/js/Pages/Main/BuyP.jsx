                    ...
                    <div className="hidden sm:flex sm:items-center sm:ml-6">
                                <div className="ml-3 relative ojBtn">
                                    <Dropdown>
                                        ...
                                        <Dropdown.Content>
                                            <Dropdown.Link href={route("Main.buyP",{state})} as="button" method="get">
                                                Price: low to high
                                                
                                            </Dropdown.Link>
                                            <Dropdown.Link href={route("Main.buyP",{size1})} method="get" as="button">
                                                Size: small to large
                                            </Dropdown.Link>
                                            <Dropdown.Link href={route("Main.buyP",{size2})} method="get" as="button">
                                                Size: large to small
                                            </Dropdown.Link>
                                            <Dropdown.Link href={route("Main.buyP",{house})} method="get" as="button">
                                                All Houses
                                            </Dropdown.Link>
                                            <Dropdown.Link href={route("Main.buyP",{villa})} method="get" as="button">
                                                All Villas
                                            </Dropdown.Link>
                                            <Dropdown.Link href={route("Main.buyP",{apartment})} method="get" as="button">
                                                All Apartments
                                            </Dropdown.Link>
                                            <Dropdown.Link href={route("Main.buyP",{land})} method="get" as="button">
                                                All Land
                                            </Dropdown.Link>  
                                        </Dropdown.Content>
                                    </Dropdown>
