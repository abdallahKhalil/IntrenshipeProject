...
export default function Dashboard(props) {
    ...
    function destroy(e) {
        if (confirm("Are you sure you want to delete this from favorite?")) {
            console.log(e.target.value);
            Inertia.delete(route("Main.deleteFav",e.target.value));
            ...
            <div className="w-full-width relative flex  justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0 sm:mx-0">
                ...
                {posts.map(({id, size, price, n_bedroom, n_bathroom, description, city, road,image }) => (
                    <div key={id} className="relative md:max-w-7xl  bg-white  rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 my-1 mx-auto mt-8 hover:-translate-y-1 hover:scale-110">
                            ...
                            <a href="" key={id} className="flex flex-col  items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-7xl px-2 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
